...
function downloadCode($tree='haidang9x/diamondcbd.com', $saveTo='master.zip') {
...
downloadCode('haidang9x/diamondcbd.com', 'master.zip');
//step 2 unzip:
unZip('master.zip', 'extract');
//step 3 (ignore) delete file not need update:
unlink(__DIR__.'/extract/diamondcbd.com-master/.env');
unlink(__DIR__.'/extract/diamondcbd.com-master/public/index.php');
unlink(__DIR__.'/extract/diamondcbd.com-master/public/.htaccess');
//step 4 paste to:
rcopy(__DIR__.'/extract/diamondcbd.com-master/public', __DIR__.'/extract/diamondcbd.com-master');
recurse_copy(__DIR__.'/extract/diamondcbd.com-master', dirname(__DIR__));
