...
<meta name="title" content="Log in | Diamond CBD" />
<link rel="canonical" href="login.htm" />
<meta name="twitter:card" content="summary" />
<meta property="og:site_name" content="Diamond CBD" />
<meta name="description" content="Login to your account at Diamond CBD to place orders, view your order history, mark your favorite products, and more." />
...
<meta property="og:description" content="Login to your account at Diamond CBD to place orders, view your order history, mark your favorite products, and more." />
...
<script>	(function (url) {
    ...
    <title>Log in | Diamond CBD</title>
  ...
  <meta name="theme-color" content="#ffffff">
    ...
    <link rel="stylesheet" href="../sites/default/files/css/css_TVZZJYg4hUZKjSgLX16-F1AxdLfZMDDZ_gWVqZyeSDw.css" media="all" />
...
<div class="off-canvas-wrapper">
  ...
  <div class="cart-empty">
    ...
    <a href="login.htm#" class="button large accent" data-close>Continue Shopping</a>
  </div>
...
<div about="/collections/pet-cbd-food">
  ...
  <a href="../collections/pet-cbd-food.htm"><img width="150" height="150" alt="Pet CBD Food is the CBD oil designed just for pets. Choose from CBD Pet Food for Cats or CBD Pet Food for Dogs of all sizes." data-src="../sites/default/files/styles/megamenu/public/2018-04/collections-pets_dfb2cce2-884e-49a5-bf83-bb94e0ca9c1e_grande.jpg?itok=ouCY4-O6" class="image-lazy-load" typeof="foaf:Image" />
    ...
    <div class="field-items">
        ...
        <a href="login.htm" title="User login page" data-drupal-link-system-path="user/login" class="is-active">Login</a>
              </li>
					...
					@if($status = Session::get('status'))
                            @if(is_array($status))
                                @foreach($status as $k => $v)
                                    @foreach($v as $e)
										<div class="zurb-foundation-callout callout alert" data-closable="fade-out" style="background-color: green; color: #fff">
														{{ $e }}
										<button class="close-button" aria-label="Dismiss alert" type="button" data-close=""><span aria-hidden="true">×</span></button>
										</div>
                                    @endforeach
...
<section id="block-diamondcbd-content" class="block-diamondcbd-content">
          ...
          <form class="user-login-form" data-drupal-selector="user-login-form" action="login.htm" method="post" id="user-login-form" accept-charset="UTF-8">
                        {{ csrf_field() }}
  <div class="js-form-item form-item js-form-type-email form-item-name js-form-item-name">
      <label for="edit-name" class="form-required">E-mail</label>
        <input autocorrect="none" autocapitalize="none" spellcheck="false" autofocus="autofocus" data-drupal-selector="edit-name" aria-describedby="edit-name--description" type="email" id="edit-name" name="email" value="{{ old('email') }}" size="60" maxlength="254" class="form-email required" required="required" aria-required="true" />
...
<div class="js-form-item form-item js-form-type-password form-item-pass js-form-item-pass">
      <label for="edit-pass" class="form-required">Password</label>
        <input data-drupal-selector="edit-pass" aria-describedby="edit-pass--description" type="password" id="edit-pass" name="password" size="60" maxlength="128" class="form-text required" required="required" aria-required="true" />
...
<div data-drupal-selector="edit-actions" class="form-actions js-form-wrapper form-wrapper" id="edit-actions"><input class="success button radius js-form-submit form-submit" data-drupal-selector="edit-submit" type="submit" id="edit-submit" name="op" value="Log in" />
          ...
          <aside class="columns large-6 show-for-large user-page-second">
                  <div class="views-element-container"><div class="user-page-slideshow js-view-dom-id-a960c213c4b4073c8bd95f69ab87ba326a1090609ded70d046cd18900451cf97">
...
<article  role="article" about="/node/264" class="node--user-page-slideshow-1 background-image" id="node-264" style="background-image: url(../sites/default/files/styles/max_1300x1300/public/2019-04/db116299.jpg?itok=jorpIL_d);">
  ...
  <div class="view-mode-user_page_slideshow_1">
    ...
    <div class="field-items">
          <div class="field-item">Save 55% on Best CBD products </div>
      </div>
</div>
    ...
    <div class="field-items">
          <div class="field-item"><p>Check out April's Box of the Month, which includes some of our best-selling CBD products. Get yours at 55% OFF. <br />
 </p>
</div>
      </div>
</div>
...
<article  role="article" about="/node/709" class="node--user-page-slideshow-1 background-image" id="node-709" style="background-image: url(../sites/default/files/styles/max_1300x1300/public/2019-04/e0fc590e.jpg?itok=DEgPqpeb);">
  ...
  <div class="view-mode-user_page_slideshow_1">
    ...
    <div class="text-box-row">
      <h4><div class="field-wrapper field field-node--field-parc-header field-name-field-parc-header field-type-string-long field-label-hidden">
    <div class="field-items">
          <div class="field-item">Oils, oils, and MORE OILS! </div>
      </div>
</div>
</h4><div class="field-wrapper field field-node--field-parc-body field-name-field-parc-body field-type-text-long field-label-hidden">
    <div class="field-items">
...
<article  role="article" about="/node/713" class="node--user-page-slideshow-1 background-image" id="node-713" style="background-image: url(../sites/default/files/styles/max_1300x1300/public/2019-03/44e85eca.jpg?itok=7hStYQ2Y);">
  ...
  <div class="view-mode-user_page_slideshow_1">
    ...
    <div class="text-box-row">
      <h4><div class="field-wrapper field field-node--field-parc-header field-name-field-parc-header field-type-string-long field-label-hidden">
    <div class="field-items">
          <div class="field-item">Get 25% OFF On All Our CBD Infused Honey Family!</div>
      </div>
</div>
</h4><div class="field-wrapper field field-node--field-parc-body field-name-field-parc-body field-type-text-long field-label-hidden">
    <div class="field-items">
  ...
  <script type="application/json" data-drupal-selector="drupal-settings-json">{"path":{"baseUrl":"\/","scriptPath":null,"pathPrefix":"","currentPath":"user\/login","currentPathIsAdmin":false,"isFront":false,"currentLanguage":"en"},"pluralDelimiter":"\u0003","ajaxPageState":{"libraries":"addtoany\/addtoany,ajax_loader\/ajax_loader.throbber,better_exposed_filters\/auto_submit,better_exposed_filters\/general,big_pipe\/big_pipe,cbd_base\/global,comment\/drupal.comment-by-viewer,commerce_cart\/cart_block,commerce_klaviyo\/drupal.commerce_klaviyo.analytics,commerce_vl\/viral_loops_scripts,core\/html5shiv,cpl_base\/age_confirmation,cpl_base\/global,cpl_base\/slideshow,cpl_base_commerce\/global,cpl_base_commerce\/image_zoom,dcom_privy\/dcom_privy,dcom_zendesk\/dcom_zendesk,diamondcbd\/global,flag\/flag.link_ajax,google_analytics\/google_analytics,layout_discovery\/onecol,photoswipe\/photoswipe,photoswipe\/photoswipe.init,simple_megamenu\/base,system\/base,video_embed_field\/responsive-video,views\/views.ajax,views\/views.module,zurb_foundation\/global","theme":"diamondcbd","theme_token":"DRtAEcqtL-UvxlClifQ7JH2264Xf-trNmRMHP8qpFvM"},"ajaxTrustedUrl":{"form_action_p_pvdeGsVG5zNF_XLGPTvYSKCf43t8qZYSwcfZl2uzM":true},"bigPipePlaceholderIds":[],"ajaxLoader":{"markup":"\u003Cdiv class=\u0022ajax-throbber sk-circle\u0022\u003E\n              \u003Cdiv class=\u0022sk-circle1 sk-child\u0022\u003E\u003C\/div\u003E\n              \u003Cdiv class=\u0022sk-circle2 sk-child\u0022\u003E\u003C\/div\u003E\n              \u003Cdiv class=\u0022sk-circle3 sk-child\u0022\u003E\u003C\/div\u003E\n              \u003Cdiv class=\u0022sk-circle4 sk-child\u0022\u003E\u003C\/div\u003E\n              \u003Cdiv class=\u0022sk-circle5 sk-child\u0022\u003E\u003C\/div\u003E\n              \u003Cdiv class=\u0022sk-circle6 sk-child\u0022\u003E\u003C\/div\u003E\n              \u003Cdiv class=\u0022sk-circle7 sk-child\u0022\u003E\u003C\/div\u003E\n              \u003Cdiv class=\u0022sk-circle8 sk-child\u0022\u003E\u003C\/div\u003E\n              \u003Cdiv class=\u0022sk-circle9 sk-child\u0022\u003E\u003C\/div\u003E\n              \u003Cdiv class=\u0022sk-circle10 sk-child\u0022\u003E\u003C\/div\u003E\n              \u003Cdiv class=\u0022sk-circle11 sk-child\u0022\u003E\u003C\/div\u003E\n              \u003Cdiv class=\u0022sk-circle12 sk-child\u0022\u003E\u003C\/div\u003E\n            \u003C\/div\u003E","hideAjaxMessage":true,"alwaysFullscreen":true,"throbberPosition":".dialog-off-canvas-main-canvas"},"commerce_klaviyo":{"public_key":"Hpm5Wb"},"google_analytics":{"trackOutbound":true,"trackMailto":true,"trackDownload":true,"trackDownloadExtensions":"7z|aac|arc|arj|asf|asx|avi|bin|csv|doc(x|m)?|dot(x|m)?|exe|flv|gif|gz|gzip|hqx|jar|jpe?g|js|mp(2|3|4|e?g)|mov(ie)?|msi|msp|pdf|phps|png|ppt(x|m)?|pot(x|m)?|pps(x|m)?|ppam|sld(x|m)?|thmx|qtm?|ra(m|r)?|sea|sit|tar|tgz|torrent|txt|wav|wma|wmv|wpd|xls(x|m|b)?|xlt(x|m)|xlam|xml|z|zip"},"user":{"uid":0,"permissionsHash":"5ca58039d4f4a6bd3e4ba0451a53189145d03914cbc558bd83288d94cb6e814b"}}</script>
<script src="../sites/default/files/js/js_jMPb-FUbwOCstGW4VqWwL1rB3t6jpAnkGprpUdQXeuw.js"></script>
<script src="../static.addtoany.com/menu/page.js" async></script>
<script src="../sites/default/files/js/js_Zf2vkGZQDKDxXNl6tVuOiu3OpNRdxeyDYbFDp7EvtxA.js"></script>
<script type="text/javascript">window.NREUM||(NREUM={});NREUM.info={"beacon":"bam.nr-data.net","licenseKey":"5fcbae9ee2","applicationID":"122518095","transactionName":"bwdVMEdTWkRTVUMNClZNdgdBW1tZHUZWAwBnAVYHXVc=","queueTime":0,"applicationTime":19,"atts":"Q0BWRg9JSUo=","errorBeacon":"bam.nr-data.net","agent":""}</script></body>
</html>
